var RENDER = (function (_data, _config) {
    ...
    function renderQuestionOpen(meetingPatientQuestionID) {
        ...
        html += '<div class="row><div class="col"><h2><span class="badge badge-pill  vote-count ">Votes cast: <span class="number-of-votes odometer"> ' + voteCount + '</span></span></h2></div></div>';
